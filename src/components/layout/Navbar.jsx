 ...
 * يسار: شعار | يمين: صورة المستخدم + اسمه + قائمة منسدلة
 */
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between">
        ...
        <div className="relative" ref={menuRef}>
          ...
          >
            ...
            {/* الاسم — مخفي على الشاشات الصغيرة جداً */}
            <span
          ...
          <AnimatePresence>
            {menuOpen && (
              ...
              >
                ...
                >
                  ...
                  <span
                    ...
                    style={{
                      ...
                      color:
                        user?.plan === 'subscribed' ? '#3FB950' : '#FF6B35',
                      fontFamily: 'Cairo, sans-serif',
                    }}
                  >
                ...
                {/* ترقية الخطة — تظهر فقط إذا كان مجانياً */}
